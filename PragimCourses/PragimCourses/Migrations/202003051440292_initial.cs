    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.CategoryId, t.CourseId })
                .ForeignKey("dbo.Categories", t => t.CategoryId, cascadeDelete: true)
                .ForeignKey("dbo.Courses", t => t.CourseId, cascadeDelete: true)
                .Index(t => new { t.CategoryId, t.CourseId }, unique: true, name: "CK_CategoryCourse");
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .Index(t => new { t.Header, t.Description }, unique: true, name: "Ak_Course");
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Courses", "AK_Course");
            DropIndex("dbo.Courses", "Ak_Course");
            DropIndex("dbo.CourseCategories", "CK_CategoryCourse");
